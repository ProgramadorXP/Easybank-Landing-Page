  ...
  return (
    <div
      className={`transition-all duration-700 relative ${
        isOpenMenu
          ? "bg-gradient-to-b from-zinc-900 to-transparent bg-opacity-75"
          : ""
      }`}
    >
      {/* Header */}
      <header className="sticky z-10 top-0 flex justify-between items-center p-6 bg-zinc-50 border border-b-black xl:px-20">
        <div>
        ...
        <span
          className="hover:scale-110 transition-transform cursor-pointer md:hidden"
          onClick={menuBar}
        >
          {isOpenMenu ? (
        ...
        <nav
          className={`absolute top-0 left-0 w-full md:static md:translate-y-0 md:w-fit ${
            isOpenMenu ? " translate-y-16" : "-translate-y-[80rem]"
          } transition-all duration-700`}
        >
          <ul className="bg-zinc-50 w-11/12 mx-auto mt-6 rounded-md md:flex md:mt-0 md:w-full xl:gap-8">
            <li className="p-2 text-center">
              <a href="#" className="font-semibold hover:scale-110">
                Home
              </a>
            </li>
            <li className="p-2 text-center">
        ...
        <div className="hidden md:flex justify-center">
          <button className="bg-gradient-to-r from-green-400 to-cyan-500 rounded-3xl px-6 py-2 text-zinc-50 font-semibold">
            Request Invite
          </button>
        </div>
      </header>
      {/* Banner */}
      <div className="flex flex-col mb-14 md:flex-row-reverse lg:justify-between xl:px-20 xl:h-[80lvh]">
        <div className="relative -z-20 xl:flex-1">
          <svg
        ...
        <div className="w-3/4 mx-auto flex flex-col gap-5 my-5 lg:w-1/2 lg:px-20 lg:mx-0 lg:justify-center">
          <h1 className="text-4xl text-center font-semibold lg:text-left">
            Next generation digital banking
          </h1>
          <p className="text-zinc-400 font-medium text-center lg:text-left">
            Take your financial life online. Your Easybank account will be a
            one-shop for spending, saving, budgeting, investing, and much more.
          </p>
      ...
      <main className="px-6 xl:px-20">
        ...
        <section className="grid bg-zinc-100 grid-rows-5 gap-6 py-14 md:grid-cols-2 md:grid-rows-3 lg:grid-cols-4 lg:grid-rows-[1fr]">
          <div className="flex flex-col gap-6 items-center text-center md:col-span-2 lg:col-span-4 ">
            <h2 className="text-3xl w-1/2">Why choose Easybank?</h2>
            <p className="w-3/4 text-zinc-400 font-medium">
          ...
          <article className="flex flex-col gap-6">
            ...
            <h3 className="text-2xl text-center">Online Banking</h3>
            <p className="w-3/4 mx-auto text-center text-zinc-400 font-medium">
          ...
          <article className="flex flex-col gap-6">
            ...
            <h3 className="text-2xl text-center">Simple Budgeting</h3>
            <p className="w-3/4 mx-auto text-center text-zinc-400 font-medium">
              See exactly where your money goes each month. Receive
              notifications when your are close to your hitting limits.
            </p>
          </article>
          <article className="flex flex-col gap-6">
            <div className="mx-auto">
            ...
            <h3 className="text-2xl text-center">Fast Onboarding</h3>
            <p className="w-3/4 mx-auto text-center text-zinc-400 font-medium">
          ...
          <article className="flex flex-col gap-6">
            ...
            <h3 className="text-2xl text-center">Open API</h3>
            <p className="w-3/4 mx-auto text-center text-zinc-400 font-medium">
              Manage your savings, investments, pension, and much more from one
              account. Tracking your oney has never been easier.
            </p>
          </article>
        </section>
        {/* Section Latest Articles */}
        <section className="py-20 grid grid-rows-[fit-content_1fr] gap-6 md:grid-cols-2 md:grid-rows-[fit-content_1fr_1fr] xl:grid-cols-4">
          <h3 className="text-3xl text-center mb-4 md:col-span-2 xl:col-span-4">
            Latest Articles
          </h3>
          <article className="bg-zinc-50 flex flex-col">
            ...
            <div className="p-8 rounded-b-md flex flex-col gap-2">
          ...
          <article className="bg-zinc-50 flex flex-col">
            ...
            <div className="p-8 rounded-b-md flex flex-col gap-2">
              ...
              <h4 className="text-xl">
                Treat yourself without worring about money
              </h4>
              <p className="font-medium text-zinc-400 text-sm">
          ...
          <article className="bg-zinc-50 flex flex-col">
            ...
            <div className="p-8 rounded-b-md flex flex-col gap-2">
              ...
              <p className="font-medium text-zinc-400 text-sm">
                After a lot of hard work by he whole team, we{"'"}re excited to
      ...
      <footer className="footer px-6 py-10 grid grid-rows-[fit-content] gap-8 md:grid-cols-3 md:grid-rows-1 xl:px-20">
        ...
        <ul className="grid grid-cols-1 justify-items-center items-center gap-4 lg:grid-cols-2 lg:justify-items-start xl:grid-cols-3">
          <li>
            <a href="#" className="text-zinc-100 font-semibold">
              About Us
            </a>
          </li>
          <li>
        ...
        <div className="flex flex-col items-center gap-6 justify-center lg:items-end">
          <div>
            <button className="bg-gradient-to-r from-green-400 to-cyan-500 rounded-3xl px-6 py-2 text-zinc-50 font-semibold">
              Request Invite
            </button>
